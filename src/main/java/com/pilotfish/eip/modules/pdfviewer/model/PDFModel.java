...
public class PDFModel extends AbstractModel{
    ...
    private Log log = LogFactory.getLog(PDFModel.class);
    ...
    public void setPdfFile(File pdfFile){
        log.trace("Setting PDF file to display. File: " + pdfFile.toString());
    ...
    public void setOrientation(int orientation){
        String orientationString = orientation == ImageSizeConverter.PORTRAIT ? "Portrait" : "Landscape";
        log.trace("Setting orienation. Orientation: " + orientationString);
    ...
    public void setPageImages(List<BufferedImage> pageImages){
        log.trace("Setting page images. # Pages: " + pageImages.size());
    ...
    public void setPageDisplayed(int pageNumber){
        log.trace("Setting page displayed. Page #: " + pageNumber);
    ...
    public void setDisplaySize(Dimension displaySize){
        log.trace("Setting display size. Width: " + displaySize.width + " Height: " + displaySize.height);
